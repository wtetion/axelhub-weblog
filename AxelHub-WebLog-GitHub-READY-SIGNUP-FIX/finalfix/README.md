...
Configured public URL: `http://127.0.0.1:3000`
...
The source is GitHub-ready. GitHub is the repository; it is not the runtime for this Express app. Use the included `render.yaml` with a GitHub-connected Render Web Service (or another Node web host) and configure `PUBLIC_BASE_URL=http://127.0.0.1:3000`, `AUTH_SECRET`, and persistent `DATA_DIR`. See `README_DEPLOY_GITHUB.md`.
...
```lua
local WEBLOG_URL = "http://127.0.0.1:3000/api/telemetry"
